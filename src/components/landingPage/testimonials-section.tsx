...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "The AI Tutor explains concepts so clearly! I finally understood algebra after struggling for months. It feels like having a personal teacher 24/7.",
      name: "Ananya Sharma",
      company: "High School Student, CBSE Board",
      image:
    ...
    {
      quote:
        "As a parent, I’ve seen a big improvement in my son’s confidence. The daily quizzes and progress reports keep him motivated to study consistently.",
      name: "Ravi Kumar",
      company: "Parent of 9th Grader",
      image:
    ...
    {
      quote:
        "Our school adopted the AI Tutor platform for science prep. Teachers love the analytics, and students are actually enjoying practice tests!",
      name: "Meena Joseph",
      company: "Principal, St. Mary’s Matriculation School",
      image:
